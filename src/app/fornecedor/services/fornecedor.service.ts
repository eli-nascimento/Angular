...
export class FornecedorService extends BaseService {
    ...
    novoFornecedor(fornecedores: Fornecedor): Observable<Fornecedor> {
        return this.http
            .post(this.UrlServiceV1 + "fornecedores", fornecedores, this.ObterAuthHeaderJson())
            .pipe(
    ...
    atualizarFornecedor(fornecedor: Fornecedor): Observable<Fornecedor> {
        console.log(this.UrlServiceV1 + "fornecedores/" + fornecedor.id, fornecedor, super.ObterAuthHeaderJson());
          return this.http
    ...
    atualizarEndereco(endereco: Endereco): Observable<Endereco> {
        console.log(this.UrlServiceV1 + "fornecedores/endereco/" + endereco.id, endereco, super.ObterAuthHeaderJson());
        return this.http
